...
echo export HADOOP_INSTALL=#{node['apache_hadoop']['dir']}/hadoop >> /home/#{username}/.bash_profile
# '' (single quoting) a string causes its variables not to be dereferenced
echo 'export PATH=\$PATH:#{node['apache_hadoop']['dir']}/hadoop/bin' >> /home/#{username}/.bash_profile
# \\ has the same effect as a single '\' on singly quoted string
echo export PATH=\\$PATH:#{node['apache_hadoop']['dir']}/hadoop/sbin >> /home/#{username}/.bash_profile
echo export HADOOP_MAPRED_HOME=#{node['apache_hadoop']['dir']}/hadoop >> /home/#{username}/.bash_profile
echo export HADOOP_COMMON_HOME=#{node['apache_hadoop']['dir']}/hadoop >> /home/#{username}/.bash_profile
echo export HADOOP_HDFS_HOME=#{node['apache_hadoop']['dir']}/hadoop >> /home/#{username}/.bash_profile
echo export YARN_HOME=#{node['apache_hadoop']['dir']}/hadoop >> /home/#{username}/.bash_profile
echo export HADOOP_HOME=#{node['apache_hadoop']['dir']}/hadoop >> /home/#{username}/.bash_profile

echo export HADOOP_CONF_DIR=#{node['apache_hadoop']['dir']}/hadoop/etc/hadoop >> /home/#{username}/.bash_profile
echo export YARN_CONF_DIR=#{node['apache_hadoop']['dir']}/hadoop/etc/hadoop >> /home/#{username}/.bash_profile

echo export HADOOP_PID_DIR=#{node['apache_hadoop']['dir']}/hadoop/logs >> /home/#{username}/.bash_profile
echo export YARN_PID_DIR=#{node['apache_hadoop']['dir']}/hadoop/logs >> /home/#{username}/.bash_profile
